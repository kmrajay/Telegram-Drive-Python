...
export function AuthWizard({ onLogin }: { onLogin: () => void }) {
    ...
    useEffect(() => {
        const savedId = localStorage.getItem('tg_drive_api_id');
        const savedHash = localStorage.getItem('tg_drive_api_hash');
    ...
    const saveCredentials = () => {
        localStorage.setItem('tg_drive_api_id', apiId);
        localStorage.setItem('tg_drive_api_hash', apiHash);
    };
                            ...
                            <div className="space-y-6 text-telegram-text">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-sm text-telegram-subtext ml-8">
                                        Visit <a href="https://my.telegram.org" target="_blank" rel="noopener noreferrer" className="text-telegram-primary underline hover:text-telegram-text cursor-pointer">my.telegram.org</a> and log in with your phone number.
                                    </p>
                                </div>
